    ...
    <div className=''>
       ...
       <div className='container'>
          <div className='about_row'>
               ...
               <img className="about_img1" src={Logo1} height={300} width={300} />
          ...
          <div className='about_column'>
               <img className="about_img2" src={Logo2} height={300} width={300} /> 
          ...
          <div className='about_column'>
               <img className="about_img3" src={Logo3} height={300} width={300} />   
